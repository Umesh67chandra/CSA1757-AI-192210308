...
def minimax(depth, node, maximizing_player, alpha, beta):
    ...
    if maximizing_player:
        ...
        for child in get_children(node):
            eval = minimax(depth - 1, child, False, alpha, beta)
        ...
        min_eval = math.inf
        for child in get_children(node):
            eval = minimax(depth - 1, child, True, alpha, beta)
...
def best_move(root, depth):
    ...
    for child in get_children(root):
        move_val = minimax(depth, child, False, -math.inf, math.inf)
